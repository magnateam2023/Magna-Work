<template>
    ...
    <div class="dash_header">
      <a href="#/dailyEmergency" class="back_button">&laquo; Daily</a>
      <span class="header_title">
        Weekly Emergencies
      </span>
      <a href="#/monthlyEmergency" class="next_button">Monthly &raquo;</a>
    </div>
...
export default {
  ...
  mounted() {
      ...
      var options = {
        url: "https://us-east-1.quicksight.aws.amazon.com/sn/accounts/175814219454/dashboards/6bd580e5-2bf9-42d5-aca0-16c945696ca7?directory_alias=magna-corp-rnd",  
