<template>
    ...
    <div class="dash_header">
      <a href="#/weeklyEmergency" class="back_button">&laquo; Weekly</a>  
      <span class="header_title">
        Monthly Emergencies
      </span>
      <a href="#/lifetimeEmergency" class="next_button">Lifetime &raquo;</a>
    </div>
...
export default {
  ...
  mounted() {
      ...
      var options = {
        url: "https://us-east-1.quicksight.aws.amazon.com/sn/accounts/175814219454/dashboards/8aa67089-57c1-4625-a183-a5073a2734ec?directory_alias=magna-corp-rnd",  
